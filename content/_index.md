...
sections:
  - block: hero
    content:
      title: |
        <div style="font-size: 36px; font-weight: bold;">数据工程与多模态智能实验室</font>
      image:
        filename: 人大照片.png
      text: |
        <br>
  ...
  - block: markdown
    content:
      ...
      text: "![llm](llm.png)<div style=\"text-align: center;font-size: 24px; font-weight: bold;\">智慧治理与行业智能（SG&DI）、大模型与数据治理（LLM&DG）</div><br><div style=\"text-align: center;font-size: 24px; font-weight: bold;\">多模态与知识工程（MM&KE）、大小模型协同学习（ModelCollab）</div>"
